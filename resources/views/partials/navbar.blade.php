...
<nav  id="navbar" class="navbar navbar-expand-lg navbar-light" style="background-color: transparent; transition: background-color 0.5s;">
    <div class="container">
        <a class="navbar-brand blue" href="/"><img  src="../img/logo1.svg" height="50px" style="padding: 5px;"></a>
        <a class="navbar-brand white" href="/"><img src="../img/logo2.svg" height="50px" style="padding: 5px;"></a>
        <div class="language-selector order-lg-2">
            <div class="toggle-container">
                <input type="hidden" id="languageToggle" class="toggle-checkbox">
            </div>
        </div>
        {{-- Toggler for Mobile --}}
        ...
        <div style="width: 60%" class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item"><a class="nav-link" href="/#partners">My Skills</a></li>
                    <li class="nav-item"><a class="nav-link" href="/faq">My Project</a></li>
